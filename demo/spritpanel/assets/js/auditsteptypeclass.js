...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditStepTypeHTMLDB",
        readURL:(URLPrefix + "auditsteptypeclass/read/all"),
        readAllURL:(URLPrefix + "auditsteptypeclass/read/all"),
        validateURL:(URLPrefix + "auditsteptypeclass/validate"),
        writeURL:(URLPrefix + "auditsteptypeclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditStepTypeReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditStepTypeWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditStepTypeTableHTMLDB",
        readURL:(URLPrefix + "auditsteptypeclass/readtable/all"),
        readAllURL:(URLPrefix + "auditsteptypeclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditStepTypeRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "auditsteptypeclass/readsession"),
        readAllURL:(URLPrefix + "auditsteptypeclass/readsession"),
        writeURL:(URLPrefix + "auditsteptypeclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditStepTypeHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditStepTypeHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditStepTypeHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditStepTypeTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditStepTypeHTMLDB", true);
...
function doHTMLDBAuditStepTypeReadAll() {
    HTMLDB.read("divAuditStepTypeTableHTMLDB", true);
}
function doHTMLDBAuditStepTypeWrite() {
    HTMLDB.read("divAuditStepTypeHTMLDB", true);
}
function doHTMLDBAuditStepTypeRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditStepTypeHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditStepTypeHTMLDB_tr" + id);
    ...
    HTMLDB.write("divAuditStepTypeHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditStepTypeHTMLDB_tr";
    var strTR2Prefix = "divAuditStepTypeTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divAuditStepTypeHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditStepTypeHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditStepTypeHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
