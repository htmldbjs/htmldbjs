...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditStepCategoryHTMLDB",
        readURL:(URLPrefix + "auditstepcategoryclass/read/all"),
        readAllURL:(URLPrefix + "auditstepcategoryclass/read/all"),
        validateURL:(URLPrefix + "auditstepcategoryclass/validate"),
        writeURL:(URLPrefix + "auditstepcategoryclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditStepCategoryReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditStepCategoryWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditStepCategoryTableHTMLDB",
        readURL:(URLPrefix + "auditstepcategoryclass/readtable/all"),
        readAllURL:(URLPrefix + "auditstepcategoryclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditStepCategoryRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "auditstepcategoryclass/readsession"),
        readAllURL:(URLPrefix + "auditstepcategoryclass/readsession"),
        writeURL:(URLPrefix + "auditstepcategoryclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditStepCategoryHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditStepCategoryHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditStepCategoryHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditStepCategoryTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditStepCategoryHTMLDB", true);
...
function doHTMLDBAuditStepCategoryReadAll() {
    HTMLDB.read("divAuditStepCategoryTableHTMLDB", true);
}
function doHTMLDBAuditStepCategoryWrite() {
    HTMLDB.read("divAuditStepCategoryHTMLDB", true);
}
function doHTMLDBAuditStepCategoryRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditStepCategoryHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditStepCategoryHTMLDB_tr" + id);
    ...
    HTMLDB.write("divAuditStepCategoryHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditStepCategoryHTMLDB_tr";
    var strTR2Prefix = "divAuditStepCategoryTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divAuditStepCategoryHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditStepCategoryHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditStepCategoryHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
