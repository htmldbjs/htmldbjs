...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divApplicationTaskCategoryHTMLDB",
        readURL:(URLPrefix + "applicationtaskcategoryclass/read/all"),
        readAllURL:(URLPrefix + "applicationtaskcategoryclass/read/all"),
        validateURL:(URLPrefix + "applicationtaskcategoryclass/validate"),
        writeURL:(URLPrefix + "applicationtaskcategoryclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBApplicationTaskCategoryReadAll,
        onRead:null,
        onWrite:doHTMLDBApplicationTaskCategoryWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divApplicationTaskCategoryTableHTMLDB",
        readURL:(URLPrefix + "applicationtaskcategoryclass/readtable/all"),
        readAllURL:(URLPrefix + "applicationtaskcategoryclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBApplicationTaskCategoryRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "applicationtaskcategoryclass/readsession"),
        readAllURL:(URLPrefix + "applicationtaskcategoryclass/readsession"),
        writeURL:(URLPrefix + "applicationtaskcategoryclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divApplicationTaskCategoryHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divApplicationTaskCategoryHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divApplicationTaskCategoryHTMLDB_tbody").innerHTML = "";
        document.getElementById("divApplicationTaskCategoryTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divApplicationTaskCategoryHTMLDB", true);
...
function doHTMLDBApplicationTaskCategoryReadAll() {
    HTMLDB.read("divApplicationTaskCategoryTableHTMLDB", true);
}
function doHTMLDBApplicationTaskCategoryWrite() {
    HTMLDB.read("divApplicationTaskCategoryHTMLDB", true);
}
function doHTMLDBApplicationTaskCategoryRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divApplicationTaskCategoryHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divApplicationTaskCategoryHTMLDB_tr" + id);
    ...
    HTMLDB.write("divApplicationTaskCategoryHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divApplicationTaskCategoryHTMLDB_tr";
    var strTR2Prefix = "divApplicationTaskCategoryTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divApplicationTaskCategoryHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divApplicationTaskCategoryHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divApplicationTaskCategoryHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
