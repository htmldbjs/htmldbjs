...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divChecklistHTMLDB",
        readURL:(URLPrefix + "checklistclass/read/all"),
        readAllURL:(URLPrefix + "checklistclass/read/all"),
        validateURL:(URLPrefix + "checklistclass/validate"),
        writeURL:(URLPrefix + "checklistclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBChecklistReadAll,
        onRead:null,
        onWrite:doHTMLDBChecklistWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divChecklistTableHTMLDB",
        readURL:(URLPrefix + "checklistclass/readtable/all"),
        readAllURL:(URLPrefix + "checklistclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBChecklistRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "checklistclass/readsession"),
        readAllURL:(URLPrefix + "checklistclass/readsession"),
        writeURL:(URLPrefix + "checklistclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "checklistclass/readpropertyoptions/firm_id"),
        readAllURL:(URLPrefix + "checklistclass/readpropertyoptions/firm_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divChecklistHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divChecklistHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divChecklistHTMLDB_tbody").innerHTML = "";
        document.getElementById("divChecklistTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divChecklistHTMLDB", true);
...
function doHTMLDBChecklistReadAll() {
    HTMLDB.read("divChecklistTableHTMLDB", true);
}
function doHTMLDBChecklistWrite() {
    HTMLDB.read("divChecklistHTMLDB", true);
}
function doHTMLDBChecklistRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divChecklistHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divChecklistHTMLDB_tr" + id);
    ...
    HTMLDB.write("divChecklistHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divChecklistHTMLDB_tr";
    var strTR2Prefix = "divChecklistTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divChecklistHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divChecklistHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divChecklistHTMLDB", id);
