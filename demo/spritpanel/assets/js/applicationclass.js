...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divApplicationHTMLDB",
        readURL:(URLPrefix + "applicationclass/read/all"),
        readAllURL:(URLPrefix + "applicationclass/read/all"),
        validateURL:(URLPrefix + "applicationclass/validate"),
        writeURL:(URLPrefix + "applicationclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBApplicationReadAll,
        onRead:null,
        onWrite:doHTMLDBApplicationWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divApplicationTableHTMLDB",
        readURL:(URLPrefix + "applicationclass/readtable/all"),
        readAllURL:(URLPrefix + "applicationclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBApplicationRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "applicationclass/readsession"),
        readAllURL:(URLPrefix + "applicationclass/readsession"),
        writeURL:(URLPrefix + "applicationclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationclass/readpropertyoptions/unit_id"),
        readAllURL:(URLPrefix + "applicationclass/readpropertyoptions/unit_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divApplicationHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divApplicationHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divApplicationHTMLDB_tbody").innerHTML = "";
        document.getElementById("divApplicationTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divApplicationHTMLDB", true);
...
function doHTMLDBApplicationReadAll() {
    HTMLDB.read("divApplicationTableHTMLDB", true);
}
function doHTMLDBApplicationWrite() {
    HTMLDB.read("divApplicationHTMLDB", true);
}
function doHTMLDBApplicationRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divApplicationHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divApplicationHTMLDB_tr" + id);
    ...
    HTMLDB.write("divApplicationHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divApplicationHTMLDB_tr";
    var strTR2Prefix = "divApplicationTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divApplicationHTMLDB", id);
