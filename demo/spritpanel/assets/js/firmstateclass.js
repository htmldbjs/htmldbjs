...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divFirmStateHTMLDB",
        readURL:(URLPrefix + "firmstateclass/read/all"),
        readAllURL:(URLPrefix + "firmstateclass/read/all"),
        validateURL:(URLPrefix + "firmstateclass/validate"),
        writeURL:(URLPrefix + "firmstateclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBFirmStateReadAll,
        onRead:null,
        onWrite:doHTMLDBFirmStateWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divFirmStateTableHTMLDB",
        readURL:(URLPrefix + "firmstateclass/readtable/all"),
        readAllURL:(URLPrefix + "firmstateclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBFirmStateRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "firmstateclass/readsession"),
        readAllURL:(URLPrefix + "firmstateclass/readsession"),
        writeURL:(URLPrefix + "firmstateclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divFirmStateHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divFirmStateHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divFirmStateHTMLDB_tbody").innerHTML = "";
        document.getElementById("divFirmStateTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divFirmStateHTMLDB", true);
...
function doHTMLDBFirmStateReadAll() {
    HTMLDB.read("divFirmStateTableHTMLDB", true);
}
function doHTMLDBFirmStateWrite() {
    HTMLDB.read("divFirmStateHTMLDB", true);
}
function doHTMLDBFirmStateRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divFirmStateHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divFirmStateHTMLDB_tr" + id);
    ...
    HTMLDB.write("divFirmStateHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divFirmStateHTMLDB_tr";
    var strTR2Prefix = "divFirmStateTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divFirmStateHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divFirmStateHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divFirmStateHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
