...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditStateHTMLDB",
        readURL:(URLPrefix + "auditstateclass/read/all"),
        readAllURL:(URLPrefix + "auditstateclass/read/all"),
        validateURL:(URLPrefix + "auditstateclass/validate"),
        writeURL:(URLPrefix + "auditstateclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditStateReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditStateWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditStateTableHTMLDB",
        readURL:(URLPrefix + "auditstateclass/readtable/all"),
        readAllURL:(URLPrefix + "auditstateclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditStateRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "auditstateclass/readsession"),
        readAllURL:(URLPrefix + "auditstateclass/readsession"),
        writeURL:(URLPrefix + "auditstateclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditStateHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditStateHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditStateHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditStateTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditStateHTMLDB", true);
...
function doHTMLDBAuditStateReadAll() {
    HTMLDB.read("divAuditStateTableHTMLDB", true);
}
function doHTMLDBAuditStateWrite() {
    HTMLDB.read("divAuditStateHTMLDB", true);
}
function doHTMLDBAuditStateRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditStateHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditStateHTMLDB_tr" + id);
    ...
    HTMLDB.write("divAuditStateHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditStateHTMLDB_tr";
    var strTR2Prefix = "divAuditStateTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divAuditStateHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditStateHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditStateHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
