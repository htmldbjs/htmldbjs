...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divActionStateHTMLDB",
        readURL:(URLPrefix + "actionstateclass/read/all"),
        readAllURL:(URLPrefix + "actionstateclass/read/all"),
        validateURL:(URLPrefix + "actionstateclass/validate"),
        writeURL:(URLPrefix + "actionstateclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBActionStateReadAll,
        onRead:null,
        onWrite:doHTMLDBActionStateWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divActionStateTableHTMLDB",
        readURL:(URLPrefix + "actionstateclass/readtable/all"),
        readAllURL:(URLPrefix + "actionstateclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBActionStateRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "actionstateclass/readsession"),
        readAllURL:(URLPrefix + "actionstateclass/readsession"),
        writeURL:(URLPrefix + "actionstateclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divActionStateHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divActionStateHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divActionStateHTMLDB_tbody").innerHTML = "";
        document.getElementById("divActionStateTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divActionStateHTMLDB", true);
...
function doHTMLDBActionStateReadAll() {
    HTMLDB.read("divActionStateTableHTMLDB", true);
}
function doHTMLDBActionStateWrite() {
    HTMLDB.read("divActionStateHTMLDB", true);
}
function doHTMLDBActionStateRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divActionStateHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divActionStateHTMLDB_tr" + id);
    ...
    HTMLDB.write("divActionStateHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divActionStateHTMLDB_tr";
    var strTR2Prefix = "divActionStateTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divActionStateHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divActionStateHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divActionStateHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
