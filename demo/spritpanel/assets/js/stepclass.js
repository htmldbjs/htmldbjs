...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divStepHTMLDB",
        readURL:(URLPrefix + "stepclass/read/all"),
        readAllURL:(URLPrefix + "stepclass/read/all"),
        validateURL:(URLPrefix + "stepclass/validate"),
        writeURL:(URLPrefix + "stepclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBStepReadAll,
        onRead:null,
        onWrite:doHTMLDBStepWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divStepTableHTMLDB",
        readURL:(URLPrefix + "stepclass/readtable/all"),
        readAllURL:(URLPrefix + "stepclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBStepRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "stepclass/readsession"),
        readAllURL:(URLPrefix + "stepclass/readsession"),
        writeURL:(URLPrefix + "stepclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divchecklist_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "stepclass/readpropertyoptions/checklist_id"),
        readAllURL:(URLPrefix + "stepclass/readpropertyoptions/checklist_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divsteptype_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "stepclass/readpropertyoptions/steptype_id"),
        readAllURL:(URLPrefix + "stepclass/readpropertyoptions/steptype_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divstepstate_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "stepclass/readpropertyoptions/stepstate_id"),
        readAllURL:(URLPrefix + "stepclass/readpropertyoptions/stepstate_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divStepHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divStepHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divStepHTMLDB_tbody").innerHTML = "";
        document.getElementById("divStepTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divStepHTMLDB", true);
...
function doHTMLDBStepReadAll() {
    HTMLDB.read("divStepTableHTMLDB", true);
}
function doHTMLDBStepWrite() {
    HTMLDB.read("divStepHTMLDB", true);
}
function doHTMLDBStepRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divStepHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divStepHTMLDB_tr" + id);
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divStepHTMLDB_tr";
    var strTR2Prefix = "divStepTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("checklist_id").selectize.setValue(0);
	document.getElementById("steptype_id").selectize.setValue(0);
	document.getElementById("stepstate_id").selectize.setValue(0);

    // Initialize Variable Values
    var arrClassProperties = HTMLDB.getColumnNames("divStepHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divStepHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divStepHTMLDB", id);
		if (parseInt(objObject["checklist_id"]) > 0) {
			document.getElementById("checklist_id").selectize.addOption(
					{value: objObject["checklist_id"],
					text: objObject["checklist_idDisplayText"]});
		}
		if (parseInt(objObject["steptype_id"]) > 0) {
			document.getElementById("steptype_id").selectize.addOption(
					{value: objObject["steptype_id"],
					text: objObject["steptype_idDisplayText"]});
		}
		if (parseInt(objObject["stepstate_id"]) > 0) {
			document.getElementById("stepstate_id").selectize.addOption(
					{value: objObject["stepstate_id"],
					text: objObject["stepstate_idDisplayText"]});
		}
        for (var i = 0; i < lClassPropertyCount; i++) {
