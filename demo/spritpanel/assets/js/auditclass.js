...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditHTMLDB",
        readURL:(URLPrefix + "auditclass/read/all"),
        readAllURL:(URLPrefix + "auditclass/read/all"),
        validateURL:(URLPrefix + "auditclass/validate"),
        writeURL:(URLPrefix + "auditclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditTableHTMLDB",
        readURL:(URLPrefix + "auditclass/readtable/all"),
        readAllURL:(URLPrefix + "auditclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "auditclass/readsession"),
        readAllURL:(URLPrefix + "auditclass/readsession"),
        writeURL:(URLPrefix + "auditclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "auditclass/readpropertyoptions/unit_id"),
        readAllURL:(URLPrefix + "auditclass/readpropertyoptions/unit_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divaudit_type_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "auditclass/readpropertyoptions/audit_type_id"),
        readAllURL:(URLPrefix + "auditclass/readpropertyoptions/audit_type_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divaudit_state_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "auditclass/readpropertyoptions/audit_state_id"),
        readAllURL:(URLPrefix + "auditclass/readpropertyoptions/audit_state_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "auditclass/readpropertyoptions/created_by"),
        readAllURL:(URLPrefix + "auditclass/readpropertyoptions/created_by"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditHTMLDB", true);
...
function doHTMLDBAuditReadAll() {
    HTMLDB.read("divAuditTableHTMLDB", true);
}
function doHTMLDBAuditWrite() {
    HTMLDB.read("divAuditHTMLDB", true);
}
function doHTMLDBAuditRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditHTMLDB_tr" + id);
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditHTMLDB_tr";
    var strTR2Prefix = "divAuditTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("audit_type_id").selectize.setValue(0);
	document.getElementById("audit_state_id").selectize.setValue(0);
	document.getElementById("created_by").selectize.setValue(0);

    // Initialize Variable Values
    var arrClassProperties = HTMLDB.getColumnNames("divAuditHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditHTMLDB", id);
		...
		if (parseInt(objObject["audit_type_id"]) > 0) {
			document.getElementById("audit_type_id").selectize.addOption(
					{value: objObject["audit_type_id"],
					text: objObject["audit_type_idDisplayText"]});
		}
		if (parseInt(objObject["audit_state_id"]) > 0) {
			document.getElementById("audit_state_id").selectize.addOption(
					{value: objObject["audit_state_id"],
					text: objObject["audit_state_idDisplayText"]});
		}
