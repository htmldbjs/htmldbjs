...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divMainStepHTMLDB",
        readURL:(URLPrefix + "mainstepclass/read/all"),
        readAllURL:(URLPrefix + "mainstepclass/read/all"),
        validateURL:(URLPrefix + "mainstepclass/validate"),
        writeURL:(URLPrefix + "mainstepclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBMainStepReadAll,
        onRead:null,
        onWrite:doHTMLDBMainStepWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divMainStepTableHTMLDB",
        readURL:(URLPrefix + "mainstepclass/readtable/all"),
        readAllURL:(URLPrefix + "mainstepclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBMainStepRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "mainstepclass/readsession"),
        readAllURL:(URLPrefix + "mainstepclass/readsession"),
        writeURL:(URLPrefix + "mainstepclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "mainstepclass/readpropertyoptions/steptype_id"),
        readAllURL:(URLPrefix + "mainstepclass/readpropertyoptions/steptype_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "mainstepclass/readpropertyoptions/stepstate_id"),
        readAllURL:(URLPrefix + "mainstepclass/readpropertyoptions/stepstate_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divMainStepHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divMainStepHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divMainStepHTMLDB_tbody").innerHTML = "";
        document.getElementById("divMainStepTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divMainStepHTMLDB", true);
...
function doHTMLDBMainStepReadAll() {
    HTMLDB.read("divMainStepTableHTMLDB", true);
}
function doHTMLDBMainStepWrite() {
    HTMLDB.read("divMainStepHTMLDB", true);
}
function doHTMLDBMainStepRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divMainStepHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divMainStepHTMLDB_tr" + id);
    ...
    HTMLDB.write("divMainStepHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divMainStepHTMLDB_tr";
    var strTR2Prefix = "divMainStepTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divMainStepHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divMainStepHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divMainStepHTMLDB", id);
