...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divApplicationSubTaskHTMLDB",
        readURL:(URLPrefix + "applicationsubtaskclass/read/all"),
        readAllURL:(URLPrefix + "applicationsubtaskclass/read/all"),
        validateURL:(URLPrefix + "applicationsubtaskclass/validate"),
        writeURL:(URLPrefix + "applicationsubtaskclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBApplicationSubTaskReadAll,
        onRead:null,
        onWrite:doHTMLDBApplicationSubTaskWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divApplicationSubTaskTableHTMLDB",
        readURL:(URLPrefix + "applicationsubtaskclass/readtable/all"),
        readAllURL:(URLPrefix + "applicationsubtaskclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBApplicationSubTaskRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "applicationsubtaskclass/readsession"),
        readAllURL:(URLPrefix + "applicationsubtaskclass/readsession"),
        writeURL:(URLPrefix + "applicationsubtaskclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divapplication_task_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "applicationsubtaskclass/readpropertyoptions/application_task_id"),
        readAllURL:(URLPrefix + "applicationsubtaskclass/readpropertyoptions/application_task_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationsubtaskclass/readpropertyoptions/responsible"),
        readAllURL:(URLPrefix + "applicationsubtaskclass/readpropertyoptions/responsible"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationsubtaskclass/readpropertyoptions/application_task_state_id"),
        readAllURL:(URLPrefix + "applicationsubtaskclass/readpropertyoptions/application_task_state_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divApplicationSubTaskHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divApplicationSubTaskHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divApplicationSubTaskHTMLDB_tbody").innerHTML = "";
        document.getElementById("divApplicationSubTaskTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divApplicationSubTaskHTMLDB", true);
...
function doHTMLDBApplicationSubTaskReadAll() {
    HTMLDB.read("divApplicationSubTaskTableHTMLDB", true);
}
function doHTMLDBApplicationSubTaskWrite() {
    HTMLDB.read("divApplicationSubTaskHTMLDB", true);
}
function doHTMLDBApplicationSubTaskRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divApplicationSubTaskHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divApplicationSubTaskHTMLDB_tr" + id);
    ...
    HTMLDB.write("divApplicationSubTaskHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divApplicationSubTaskHTMLDB_tr";
    var strTR2Prefix = "divApplicationSubTaskTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("application_task_id").selectize.setValue(0);
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divApplicationSubTaskHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divApplicationSubTaskHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divApplicationSubTaskHTMLDB", id);
		if (parseInt(objObject["application_task_id"]) > 0) {
			document.getElementById("application_task_id").selectize.addOption(
					{value: objObject["application_task_id"],
					text: objObject["application_task_idDisplayText"]});
		}
