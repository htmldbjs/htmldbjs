...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divApplicationTaskStateHTMLDB",
        readURL:(URLPrefix + "applicationtaskstateclass/read/all"),
        readAllURL:(URLPrefix + "applicationtaskstateclass/read/all"),
        validateURL:(URLPrefix + "applicationtaskstateclass/validate"),
        writeURL:(URLPrefix + "applicationtaskstateclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBApplicationTaskStateReadAll,
        onRead:null,
        onWrite:doHTMLDBApplicationTaskStateWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divApplicationTaskStateTableHTMLDB",
        readURL:(URLPrefix + "applicationtaskstateclass/readtable/all"),
        readAllURL:(URLPrefix + "applicationtaskstateclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBApplicationTaskStateRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "applicationtaskstateclass/readsession"),
        readAllURL:(URLPrefix + "applicationtaskstateclass/readsession"),
        writeURL:(URLPrefix + "applicationtaskstateclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divApplicationTaskStateHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divApplicationTaskStateHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divApplicationTaskStateHTMLDB_tbody").innerHTML = "";
        document.getElementById("divApplicationTaskStateTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divApplicationTaskStateHTMLDB", true);
...
function doHTMLDBApplicationTaskStateReadAll() {
    HTMLDB.read("divApplicationTaskStateTableHTMLDB", true);
}
function doHTMLDBApplicationTaskStateWrite() {
    HTMLDB.read("divApplicationTaskStateHTMLDB", true);
}
function doHTMLDBApplicationTaskStateRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divApplicationTaskStateHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divApplicationTaskStateHTMLDB_tr" + id);
    ...
    HTMLDB.write("divApplicationTaskStateHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divApplicationTaskStateHTMLDB_tr";
    var strTR2Prefix = "divApplicationTaskStateTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divApplicationTaskStateHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divApplicationTaskStateHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divApplicationTaskStateHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
