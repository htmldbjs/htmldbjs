...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divCoordinatorHTMLDB",
        readURL:(URLPrefix + "coordinatorclass/read/all"),
        readAllURL:(URLPrefix + "coordinatorclass/read/all"),
        validateURL:(URLPrefix + "coordinatorclass/validate"),
        writeURL:(URLPrefix + "coordinatorclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBCoordinatorReadAll,
        onRead:null,
        onWrite:doHTMLDBCoordinatorWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divCoordinatorTableHTMLDB",
        readURL:(URLPrefix + "coordinatorclass/readtable/all"),
        readAllURL:(URLPrefix + "coordinatorclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBCoordinatorRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "coordinatorclass/readsession"),
        readAllURL:(URLPrefix + "coordinatorclass/readsession"),
        writeURL:(URLPrefix + "coordinatorclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divfirm_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "coordinatorclass/readpropertyoptions/firm_id"),
        readAllURL:(URLPrefix + "coordinatorclass/readpropertyoptions/firm_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divCoordinatorHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divCoordinatorHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divCoordinatorHTMLDB_tbody").innerHTML = "";
        document.getElementById("divCoordinatorTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divCoordinatorHTMLDB", true);
...
function doHTMLDBCoordinatorReadAll() {
    HTMLDB.read("divCoordinatorTableHTMLDB", true);
}
function doHTMLDBCoordinatorWrite() {
    HTMLDB.read("divCoordinatorHTMLDB", true);
}
function doHTMLDBCoordinatorRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divCoordinatorHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divCoordinatorHTMLDB_tr" + id);
    ...
    HTMLDB.write("divCoordinatorHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divCoordinatorHTMLDB_tr";
    var strTR2Prefix = "divCoordinatorTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("firm_id").selectize.setValue(0);

    // Initialize Variable Values
    var arrClassProperties = HTMLDB.getColumnNames("divCoordinatorHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divCoordinatorHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divCoordinatorHTMLDB", id);
		if (parseInt(objObject["firm_id"]) > 0) {
			document.getElementById("firm_id").selectize.addOption(
					{value: objObject["firm_id"],
					text: objObject["firm_idDisplayText"]});
		}
        for (var i = 0; i < lClassPropertyCount; i++) {
