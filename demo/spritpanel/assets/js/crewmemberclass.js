...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divCrewMemberHTMLDB",
        readURL:(URLPrefix + "crewmemberclass/read/all"),
        readAllURL:(URLPrefix + "crewmemberclass/read/all"),
        validateURL:(URLPrefix + "crewmemberclass/validate"),
        writeURL:(URLPrefix + "crewmemberclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBCrewMemberReadAll,
        onRead:null,
        onWrite:doHTMLDBCrewMemberWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divCrewMemberTableHTMLDB",
        readURL:(URLPrefix + "crewmemberclass/readtable/all"),
        readAllURL:(URLPrefix + "crewmemberclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBCrewMemberRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "crewmemberclass/readsession"),
        readAllURL:(URLPrefix + "crewmemberclass/readsession"),
        writeURL:(URLPrefix + "crewmemberclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divcrew_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "crewmemberclass/readpropertyoptions/crew_id"),
        readAllURL:(URLPrefix + "crewmemberclass/readpropertyoptions/crew_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divCrewMemberHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divCrewMemberHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divCrewMemberHTMLDB_tbody").innerHTML = "";
        document.getElementById("divCrewMemberTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divCrewMemberHTMLDB", true);
...
function doHTMLDBCrewMemberReadAll() {
    HTMLDB.read("divCrewMemberTableHTMLDB", true);
}
function doHTMLDBCrewMemberWrite() {
    HTMLDB.read("divCrewMemberHTMLDB", true);
}
function doHTMLDBCrewMemberRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divCrewMemberHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divCrewMemberHTMLDB_tr" + id);
    ...
    HTMLDB.write("divCrewMemberHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divCrewMemberHTMLDB_tr";
    var strTR2Prefix = "divCrewMemberTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("crew_id").selectize.setValue(0);

    // Initialize Variable Values
    var arrClassProperties = HTMLDB.getColumnNames("divCrewMemberHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divCrewMemberHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divCrewMemberHTMLDB", id);
		if (parseInt(objObject["crew_id"]) > 0) {
			document.getElementById("crew_id").selectize.addOption(
					{value: objObject["crew_id"],
					text: objObject["crew_idDisplayText"]});
		}
        for (var i = 0; i < lClassPropertyCount; i++) {
