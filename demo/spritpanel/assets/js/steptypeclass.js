...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divStepTypeHTMLDB",
        readURL:(URLPrefix + "steptypeclass/read/all"),
        readAllURL:(URLPrefix + "steptypeclass/read/all"),
        validateURL:(URLPrefix + "steptypeclass/validate"),
        writeURL:(URLPrefix + "steptypeclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBStepTypeReadAll,
        onRead:null,
        onWrite:doHTMLDBStepTypeWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divStepTypeTableHTMLDB",
        readURL:(URLPrefix + "steptypeclass/readtable/all"),
        readAllURL:(URLPrefix + "steptypeclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBStepTypeRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "steptypeclass/readsession"),
        readAllURL:(URLPrefix + "steptypeclass/readsession"),
        writeURL:(URLPrefix + "steptypeclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divStepTypeHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divStepTypeHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divStepTypeHTMLDB_tbody").innerHTML = "";
        document.getElementById("divStepTypeTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divStepTypeHTMLDB", true);
...
function doHTMLDBStepTypeReadAll() {
    HTMLDB.read("divStepTypeTableHTMLDB", true);
}
function doHTMLDBStepTypeWrite() {
    HTMLDB.read("divStepTypeHTMLDB", true);
}
function doHTMLDBStepTypeRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divStepTypeHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divStepTypeHTMLDB_tr" + id);
    ...
    HTMLDB.write("divStepTypeHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divStepTypeHTMLDB_tr";
    var strTR2Prefix = "divStepTypeTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divStepTypeHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divStepTypeHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divStepTypeHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
