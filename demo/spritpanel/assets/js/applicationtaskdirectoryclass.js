...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divApplicationTaskDirectoryHTMLDB",
        readURL:(URLPrefix + "applicationtaskdirectoryclass/read/all"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/read/all"),
        validateURL:(URLPrefix + "applicationtaskdirectoryclass/validate"),
        writeURL:(URLPrefix + "applicationtaskdirectoryclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBApplicationTaskDirectoryReadAll,
        onRead:null,
        onWrite:doHTMLDBApplicationTaskDirectoryWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divApplicationTaskDirectoryTableHTMLDB",
        readURL:(URLPrefix + "applicationtaskdirectoryclass/readtable/all"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBApplicationTaskDirectoryRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "applicationtaskdirectoryclass/readsession"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/readsession"),
        writeURL:(URLPrefix + "applicationtaskdirectoryclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/application_id"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/application_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/application_task_category_id"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/application_task_category_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/responsible"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/responsible"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/application_task_state_id"),
        readAllURL:(URLPrefix + "applicationtaskdirectoryclass/readpropertyoptions/application_task_state_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divApplicationTaskDirectoryHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divApplicationTaskDirectoryHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divApplicationTaskDirectoryHTMLDB_tbody").innerHTML = "";
        document.getElementById("divApplicationTaskDirectoryTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divApplicationTaskDirectoryHTMLDB", true);
...
function doHTMLDBApplicationTaskDirectoryReadAll() {
    HTMLDB.read("divApplicationTaskDirectoryTableHTMLDB", true);
}
function doHTMLDBApplicationTaskDirectoryWrite() {
    HTMLDB.read("divApplicationTaskDirectoryHTMLDB", true);
}
function doHTMLDBApplicationTaskDirectoryRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divApplicationTaskDirectoryHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divApplicationTaskDirectoryHTMLDB_tr" + id);
    ...
    HTMLDB.write("divApplicationTaskDirectoryHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divApplicationTaskDirectoryHTMLDB_tr";
    var strTR2Prefix = "divApplicationTaskDirectoryTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divApplicationTaskDirectoryHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divApplicationTaskDirectoryHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divApplicationTaskDirectoryHTMLDB", id);
