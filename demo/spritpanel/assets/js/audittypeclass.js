...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditTypeHTMLDB",
        readURL:(URLPrefix + "audittypeclass/read/all"),
        readAllURL:(URLPrefix + "audittypeclass/read/all"),
        validateURL:(URLPrefix + "audittypeclass/validate"),
        writeURL:(URLPrefix + "audittypeclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditTypeReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditTypeWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditTypeTableHTMLDB",
        readURL:(URLPrefix + "audittypeclass/readtable/all"),
        readAllURL:(URLPrefix + "audittypeclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditTypeRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "audittypeclass/readsession"),
        readAllURL:(URLPrefix + "audittypeclass/readsession"),
        writeURL:(URLPrefix + "audittypeclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditTypeHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditTypeHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditTypeHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditTypeTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditTypeHTMLDB", true);
...
function doHTMLDBAuditTypeReadAll() {
    HTMLDB.read("divAuditTypeTableHTMLDB", true);
}
function doHTMLDBAuditTypeWrite() {
    HTMLDB.read("divAuditTypeHTMLDB", true);
}
function doHTMLDBAuditTypeRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditTypeHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditTypeHTMLDB_tr" + id);
    ...
    HTMLDB.write("divAuditTypeHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditTypeHTMLDB_tr";
    var strTR2Prefix = "divAuditTypeTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divAuditTypeHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditTypeHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditTypeHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
