...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divChampionHTMLDB",
        readURL:(URLPrefix + "championclass/read/all"),
        readAllURL:(URLPrefix + "championclass/read/all"),
        validateURL:(URLPrefix + "championclass/validate"),
        writeURL:(URLPrefix + "championclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBChampionReadAll,
        onRead:null,
        onWrite:doHTMLDBChampionWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divChampionTableHTMLDB",
        readURL:(URLPrefix + "championclass/readtable/all"),
        readAllURL:(URLPrefix + "championclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBChampionRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "championclass/readsession"),
        readAllURL:(URLPrefix + "championclass/readsession"),
        writeURL:(URLPrefix + "championclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "championclass/readpropertyoptions/unit_id"),
        readAllURL:(URLPrefix + "championclass/readpropertyoptions/unit_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divChampionHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divChampionHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divChampionHTMLDB_tbody").innerHTML = "";
        document.getElementById("divChampionTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divChampionHTMLDB", true);
...
function doHTMLDBChampionReadAll() {
    HTMLDB.read("divChampionTableHTMLDB", true);
}
function doHTMLDBChampionWrite() {
    HTMLDB.read("divChampionHTMLDB", true);
}
function doHTMLDBChampionRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divChampionHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divChampionHTMLDB_tr" + id);
    ...
    HTMLDB.write("divChampionHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divChampionHTMLDB_tr";
    var strTR2Prefix = "divChampionTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divChampionHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divChampionHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divChampionHTMLDB", id);
