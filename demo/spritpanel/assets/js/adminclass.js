...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAdminHTMLDB",
        readURL:(URLPrefix + "adminclass/read/all"),
        readAllURL:(URLPrefix + "adminclass/read/all"),
        validateURL:(URLPrefix + "adminclass/validate"),
        writeURL:(URLPrefix + "adminclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAdminReadAll,
        onRead:null,
        onWrite:doHTMLDBAdminWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAdminTableHTMLDB",
        readURL:(URLPrefix + "adminclass/readtable/all"),
        readAllURL:(URLPrefix + "adminclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAdminRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "adminclass/readsession"),
        readAllURL:(URLPrefix + "adminclass/readsession"),
        writeURL:(URLPrefix + "adminclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAdminHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAdminHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAdminHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAdminTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAdminHTMLDB", true);
...
function doHTMLDBAdminReadAll() {
    HTMLDB.read("divAdminTableHTMLDB", true);
}
function doHTMLDBAdminWrite() {
    HTMLDB.read("divAdminHTMLDB", true);
}
function doHTMLDBAdminRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAdminHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAdminHTMLDB_tr" + id);
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAdminHTMLDB_tr";
    var strTR2Prefix = "divAdminTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divAdminHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAdminHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAdminHTMLDB", id);
        for (var i = 0; i < lClassPropertyCount; i++) {
