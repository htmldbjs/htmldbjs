...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditStepHTMLDB",
        readURL:(URLPrefix + "auditstepclass/read/all"),
        readAllURL:(URLPrefix + "auditstepclass/read/all"),
        validateURL:(URLPrefix + "auditstepclass/validate"),
        writeURL:(URLPrefix + "auditstepclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditStepReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditStepWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditStepTableHTMLDB",
        readURL:(URLPrefix + "auditstepclass/readtable/all"),
        readAllURL:(URLPrefix + "auditstepclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditStepRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "auditstepclass/readsession"),
        readAllURL:(URLPrefix + "auditstepclass/readsession"),
        writeURL:(URLPrefix + "auditstepclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "auditstepclass/readpropertyoptions/audit_id"),
        readAllURL:(URLPrefix + "auditstepclass/readpropertyoptions/audit_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "auditstepclass/readpropertyoptions/audit_step_category_id"),
        readAllURL:(URLPrefix + "auditstepclass/readpropertyoptions/audit_step_category_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "auditstepclass/readpropertyoptions/audit_step_type_id"),
        readAllURL:(URLPrefix + "auditstepclass/readpropertyoptions/audit_step_type_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditStepHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditStepHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditStepHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditStepTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditStepHTMLDB", true);
...
function doHTMLDBAuditStepReadAll() {
    HTMLDB.read("divAuditStepTableHTMLDB", true);
}
function doHTMLDBAuditStepWrite() {
    HTMLDB.read("divAuditStepHTMLDB", true);
}
function doHTMLDBAuditStepRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditStepHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditStepHTMLDB_tr" + id);
    ...
    HTMLDB.write("divAuditStepHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditStepHTMLDB_tr";
    var strTR2Prefix = "divAuditStepTableHTMLDB_tr";
...
function loadObject(id) {
    ...
    var arrClassProperties = HTMLDB.getColumnNames("divAuditStepHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditStepHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditStepHTMLDB", id);
