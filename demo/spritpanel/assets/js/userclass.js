...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "userclass/read/all"),
        readAllURL:(URLPrefix + "userclass/read/all"),
        validateURL:(URLPrefix + "userclass/validate"),
        writeURL:(URLPrefix + "userclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBUserReadAll,
        onRead:null,
    ...
    HTMLDB.initialize({
        elementID:"divUserTableHTMLDB",
        readURL:(URLPrefix + "userclass/readtable/all"),
        readAllURL:(URLPrefix + "userclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
    ...
    HTMLDB.initialize({
        ...
        readURL:(URLPrefix + "userclass/readsession"),
        readAllURL:(URLPrefix + "userclass/readsession"),
        writeURL:(URLPrefix + "userclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divcompanyPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "userclass/readpropertyoptions/company"),
        readAllURL:(URLPrefix + "userclass/readpropertyoptions/company"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        document.getElementById("divUserTableHTMLDB_tbody").innerHTML = "";
...
function doHTMLDBUserReadAll() {
    HTMLDB.read("divUserTableHTMLDB", true);
}
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divUserHTMLDB_tr" + id);
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divUserHTMLDB_tr";
    var strTR2Prefix = "divUserTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("user_type").selectize.setValue(0);
	document.getElementById("company").selectize.setValue(0);
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divUserHTMLDB", id);
		if (parseInt(objObject["company"]) > 0) {
			document.getElementById("company").selectize.addOption(
					{value: objObject["company"],
					text: objObject["companyDisplayText"]});
		}
        for (var i = 0; i < lClassPropertyCount; i++) {
