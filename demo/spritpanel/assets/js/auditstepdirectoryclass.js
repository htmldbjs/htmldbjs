...
function initializeHTMLDB() {
    ...
    HTMLDB.initialize({
        elementID:"divAuditStepDirectoryHTMLDB",
        readURL:(URLPrefix + "auditstepdirectoryclass/read/all"),
        readAllURL:(URLPrefix + "auditstepdirectoryclass/read/all"),
        validateURL:(URLPrefix + "auditstepdirectoryclass/validate"),
        writeURL:(URLPrefix + "auditstepdirectoryclass/write"),
        autoRefresh:0,
        renderElements:[],
        onReadAll:doHTMLDBAuditStepDirectoryReadAll,
        onRead:null,
        onWrite:doHTMLDBAuditStepDirectoryWrite,
        onRender:null,
        onRenderAll:null
    });

    HTMLDB.initialize({
        elementID:"divAuditStepDirectoryTableHTMLDB",
        readURL:(URLPrefix + "auditstepdirectoryclass/readtable/all"),
        readAllURL:(URLPrefix + "auditstepdirectoryclass/readtable/all"),
        writeURL:null,
        autoRefresh:0,
        renderElements:[{
        ...
        onWrite:null,
        onRender:null,
        onRenderAll:doHTMLDBAuditStepDirectoryRenderAll
    });

    HTMLDB.initialize({
        elementID:"divSessionHTMLDB",
        readURL:(URLPrefix + "auditstepdirectoryclass/readsession"),
        readAllURL:(URLPrefix + "auditstepdirectoryclass/readsession"),
        writeURL:(URLPrefix + "auditstepdirectoryclass/writesession"),
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divaudit_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "auditstepdirectoryclass/readpropertyoptions/audit_id"),
        readAllURL:(URLPrefix + "auditstepdirectoryclass/readpropertyoptions/audit_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divaudit_step_category_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "auditstepdirectoryclass/readpropertyoptions/audit_step_category_id"),
        readAllURL:(URLPrefix + "auditstepdirectoryclass/readpropertyoptions/audit_step_category_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
    ...
    HTMLDB.initialize({
        elementID:"divaudit_step_type_idPropertyOptionsHTMLDB",
        readURL:(URLPrefix + "auditstepdirectoryclass/readpropertyoptions/audit_step_type_id"),
        readAllURL:(URLPrefix + "auditstepdirectoryclass/readpropertyoptions/audit_step_type_id"),
        writeURL:"",
        writeDelay:1000,
        autoRefresh:0,
        renderElements:[],
...
function doShowMoreButtonClick(sender) {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        HTMLDB.read("divAuditStepDirectoryHTMLDB", false, function () {
            sender.disabled = false;
            HTMLDB.renderAll("divAuditStepDirectoryHTMLDB");
        });
    });
}
...
function searchList() {
    ...
    HTMLDB.write("divSessionHTMLDB", false, function () {
        ...
        resetProgressBar(
                ...
                false,
                true);
        document.getElementById("divAuditStepDirectoryHTMLDB_tbody").innerHTML = "";
        document.getElementById("divAuditStepDirectoryTableHTMLDB_tbody").innerHTML = "";
        document.getElementById("tbodyObjectList").innerHTML = "";
        document.getElementById("tbodyGhostObjectList").innerHTML = "";
        HTMLDB.read("divAuditStepDirectoryHTMLDB", true);
...
function doHTMLDBAuditStepDirectoryReadAll() {
    HTMLDB.read("divAuditStepDirectoryTableHTMLDB", true);
}
function doHTMLDBAuditStepDirectoryWrite() {
    HTMLDB.read("divAuditStepDirectoryHTMLDB", true);
}
function doHTMLDBAuditStepDirectoryRenderAll() {
    initializeObjects();
...
function validateObject(id) {
    var strHTMLDBDIVID = "divAuditStepDirectoryHTMLDB";
...
function saveObject(objObject) {
    ...
    var elTR = document.getElementById("divAuditStepDirectoryHTMLDB_tr" + id);
    ...
    HTMLDB.write("divAuditStepDirectoryHTMLDB");
...
function doDeleteConfirmButtonClick(sender) {
    ...
    var strTR1Prefix = "divAuditStepDirectoryHTMLDB_tr";
    var strTR2Prefix = "divAuditStepDirectoryTableHTMLDB_tr";
...
function loadObject(id) {
	...
	document.getElementById("audit_id").selectize.setValue(0);
	document.getElementById("audit_step_category_id").selectize.setValue(0);
	document.getElementById("audit_step_type_id").selectize.setValue(0);

    // Initialize Variable Values
    var arrClassProperties = HTMLDB.getColumnNames("divAuditStepDirectoryHTMLDB");
    var lClassPropertyCount = arrClassProperties.length;
    var elTR = document.getElementById("divAuditStepDirectoryHTMLDB_tr" + id);
    var objObject = null;
    ...
    if (elTR) {
        ...
        objObject = HTMLDB.get("divAuditStepDirectoryHTMLDB", id);
		if (parseInt(objObject["audit_id"]) > 0) {
			document.getElementById("audit_id").selectize.addOption(
					{value: objObject["audit_id"],
					text: objObject["audit_idDisplayText"]});
		}
		if (parseInt(objObject["audit_step_category_id"]) > 0) {
			document.getElementById("audit_step_category_id").selectize.addOption(
					{value: objObject["audit_step_category_id"],
					text: objObject["audit_step_category_idDisplayText"]});
		}
		if (parseInt(objObject["audit_step_type_id"]) > 0) {
			document.getElementById("audit_step_type_id").selectize.addOption(
					{value: objObject["audit_step_type_id"],
					text: objObject["audit_step_type_idDisplayText"]});
		}
        for (var i = 0; i < lClassPropertyCount; i++) {
