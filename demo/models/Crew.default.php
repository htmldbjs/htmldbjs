...
class Crew {
	...
	public function insert() {
		...
		$SQLText = str_replace('{{parameter1}}', intval($this->unit_id), $SQLText);
	...
	public function cache() {
		...
		if (!$this->deleted) {
			...
			$propertyValues['Crew/firstname'] = $this->get('Crew/firstname');
			$propertyValues['Crew/lastname'] = $this->get('Crew/lastname');
	...
	private function extractColumnValues() {
		...
		$expressionV0 = $this->getDisplayText('Crew/firstname');

		$index++;
		$this->__columnValues[$index] = $expressionV0;

		$expressionV0 = $this->getDisplayText('Crew/lastname');
