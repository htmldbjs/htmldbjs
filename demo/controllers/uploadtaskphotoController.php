...
class uploadtaskphotoController {

	public $controller = 'uploadtaskphoto';
	...
	private function getSessionParameters() {
        ...
        $sessionParameters['currentDirectory'] = 'media/' . $_SESSION['applicationControllerMediaPath'];
    ...
    public function readmedia($parameters = NULL) {
        ...
        $directoryPath = (DIR . '/media/' . $_SESSION['applicationControllerMediaPath']);
        $directoryURL = 'media/' . $_SESSION['applicationControllerMediaPath'];
    ...
    public function formupload($parameters = NULL) {
        ...
        $currentFTPDirectory = 'media/' . $_SESSION['applicationControllerMediaPath'];
