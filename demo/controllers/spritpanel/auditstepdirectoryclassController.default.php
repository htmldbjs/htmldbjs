...
class auditstepdirectoryclassController {

	public $controller = 'auditstepdirectoryclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/auditstepdirectoryclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		$listObject = new AuditStepDirectory();
