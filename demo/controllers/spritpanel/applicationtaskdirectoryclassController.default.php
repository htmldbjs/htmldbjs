...
class applicationtaskdirectoryclassController {

	public $controller = 'applicationtaskdirectoryclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/applicationtaskdirectoryclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		$listObject = new ApplicationTaskDirectory();
	...
	private function getSessionParameters() {
		...
		$sessionParameters['pageCount']
				...
				: 0);
		$sessionParameters['application_idSearchText']
				= (isset($_SESSION[sha1(__FILE__) . 'application_idSearchText'])
				? $_SESSION[sha1(__FILE__) . 'application_idSearchText']
				: '');
		$sessionParameters['application_task_category_idSearchText']
				= (isset($_SESSION[sha1(__FILE__) . 'application_task_category_idSearchText'])
				? $_SESSION[sha1(__FILE__) . 'application_task_category_idSearchText']
				: '');
