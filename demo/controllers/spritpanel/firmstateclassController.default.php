...
class firmstateclassController {

	public $controller = 'firmstateclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/firmstateclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		includeModel('FirmState');

		$listObject = new FirmState();
