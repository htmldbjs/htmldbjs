...
class applicationtaskcategoryclassController {

	public $controller = 'applicationtaskcategoryclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/applicationtaskcategoryclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		$listObject = new ApplicationTaskCategory();
