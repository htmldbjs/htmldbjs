...
class auditstepcategoryclassController {

	public $controller = 'auditstepcategoryclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/auditstepcategoryclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		$listObject = new AuditStepCategory();
