...
class applicationtaskstateclassController {

	public $controller = 'applicationtaskstateclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/applicationtaskstateclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		$listObject = new ApplicationTaskState();
