...
class pagesController {
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        includeView($this, 'spritpanel/pages');
	}
	...
	private function setServerOSInfo() {
		...
		switch (PHP_OS) {
			case 'Darwin':
				$this->strServerOSIconPath = 'img/macosx.png';
			...
			case 'Windows':
			case 'WIN32':
				$this->strServerOSIconPath = 'img/windows.png';
				$this->strServerOSHeader = 'Windows';
			break;

			default:
				$this->strServerOSIconPath = 'img/linux.png';
	...
	private function setWebServerInfo() {
		...
		if (strpos(strtolower($this->strWebServerDetail), 'apache') !== false) {
			$this->strWebServerIconPath = 'img/apache.png';
	...
	private function setApplicationInfo() {
		$this->strApplicationIconPath = 'img/php.png';
	...
	private function setDatabaseInfo() {
		...
		$this->strDatabaseIconPath = 'img/mysql.png';
        ...
        if (!$connMySQL) {
        	$this->strDatabaseDetail = __('Pages');
        } // if (!$this->connMySQL) {
