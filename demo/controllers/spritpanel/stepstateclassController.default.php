...
class stepstateclassController {

	public $controller = 'stepstateclass';
	...
	public function index($parameters = NULL, $strMethod = '') {
        ...
        if (!includeView($this, 'spritpanel/stepstateclass')) {
			includeLibrary('spritpanel/redirectToPage');
	...
	public function read($parameters = NULL) {
		...
		includeModel('StepState');

		$listObject = new StepState();
