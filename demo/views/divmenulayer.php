    ...
    for ($i=0; $i < $countMenuArray; $i++) {
        if ($menuArray[$i]['visible']) {
            ...
            if ('' == $menuArray[$i]['URL']) {
                ...
                $strHref = $_SPRIT['URL_PREFIX'] . $menuArray[$i]['URL'];
            } // if ('' == $menuArray[$i]['URL']) {
            ?>
                            ...
                            for ($j=0; $j < $countSubmenuArray; $j++) {
                                if($subMenus[$j]['visible']) {
                                    ...
                                    if ('' == $subMenus[$j]['URL']) {
                                        ...
                                        $strHref = $_SPRIT['URL_PREFIX'] . $subMenus[$j]['URL'];
                                    } // if ('' == $subMenus[$j]['URL']) {
                                    ?>
                                    <li data-parent-url="<?php echo $menuArray[$i]['id']; ?>" id="pageurl<?php echo $subMenus[$j]['id']; ?>">
                                        <a class="" href="<?php echo $_SPRIT['URL_PREFIX'] . $subMenus[$j]['URL']; ?>">
