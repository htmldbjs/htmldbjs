...
<section class="sectionContent">
    <div class="divDialogContentContainer col s12">
        <div class="divContentPanel z-depth-1">
            <button class="waves-effect white-text btn right cyan darken-1 HTMLDBAction HTMLDBEdit" type="button" data-htmldb-dialog="divCompanyDialog" data-htmldb-source="divCompanyHTMLDBReader" data-htmldb-row-id=""><i class="ion-plus"></i> YENİ FİRMA</button>
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            <th>
                                ...
                                <th>
                                    <button type="button" class="buttonTableColumn buttonTableColumn1" data-column-index="1">
                                        Tür&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i
                                        class="ion-arrow-down-b"></i></span><span
                                        class="sorting sorting-asc blue-text text-darken-4"><i
                                        class="ion-arrow-up-b"></i></span></button>
                                    </th>
            ...
            <div class="divHiddenElements">
                ...
                <table>
                    <tbody id="tbodyObjectListTemplate">
                        <tr class="tr#divCompanyHTMLDBReader.id" data-object-id="#divCompanyHTMLDBReader.id">
                            <td class="center">
                            ...
                            <td class="tdEditObject">#divCompanyHTMLDBReader.id</td>
                            <td class="tdEditObject">#divCompanyHTMLDBReader.company_name</td>
                            <td class="tdEditObject">#divCompanyHTMLDBReader.score</td>
                            <td class="tdEditObject">#divCompanyHTMLDBReader.type</td>
                            <td class="tdEditObject">#divCompanyHTMLDBReader.consultantDisplayText</td>
