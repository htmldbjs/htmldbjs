<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="stepclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Checklist'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Step'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Step'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
                        ...
                        <form id="formObject" name="formObject" method="post" class="form-horizontal">
                            ...
                            <div class="row"> 
								...
								<div class="col l12 m12 s12 " id="divchecklist_id">
									<label for="checklist_id"><?php echo __('Checklist'); ?>  </label>
									<select class="selectClassSelection" id="checklist_id" style="width: 100%" name="checklist_id" data-min-selection="2" data-max-selection="2">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('Step object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
    ...
    <div id="divBrowseMediaDialog" class="divDialogContent" data-target-file-list="" data-media-type="">
        ...
        <div class="divHiddenElements">
            <div id="divStepHTMLDB" class="divHTMLDB"></div>
            <div id="divStepTableHTMLDB" class="divHTMLDB"></div>
            <div id="divchecklist_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divStepTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divStepTableHTMLDB.id">
                                <input data-object-id="#divStepTableHTMLDB.id" class="" id="bSelectObjectGhost#divStepTableHTMLDB.id" name="bSelectObjectGhost#divStepTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divStepTableHTMLDB.id</td>
                        
<td>#divStepTableHTMLDB.column0</td>
<td>#divStepTableHTMLDB.column1</td>
<td>#divStepTableHTMLDB.column2</td>
<td>#divStepTableHTMLDB.column3</td>
<td>#divStepTableHTMLDB.column4</td>
                        <td>
                            <button data-object-id="#divStepTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divStepTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divStepTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divStepTableHTMLDB.id">
                                <input data-object-id="#divStepTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divStepTableHTMLDB.id" name="bSelectObject#divStepTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divStepTableHTMLDB.column4</td>
        ...
        <script src="assets/js/stepclass.js"></script>
    </body>
</html>