<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="coordinatorclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Firm'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Phone'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Coordinator'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Phone'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Coordinator'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
	...
	<div class="col l12 m12 s12 " id="divenabled">
								...
								<div class="col l12 m12 s12 " id="divfirm_id">
									<label for="firm_id"><?php echo __('Firm'); ?>  </label>
									<select class="selectClassSelection" id="firm_id" style="width: 100%" name="firm_id" data-min-selection="2" data-max-selection="2">
	...
	<div class="col l12 m12 s12 " id="divpassword">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('Coordinator object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
        ...
        <div class="divHiddenElements">
            <div id="divCoordinatorHTMLDB" class="divHTMLDB"></div>
            <div id="divCoordinatorTableHTMLDB" class="divHTMLDB"></div>
            <div id="divfirm_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divSessionHTMLDB" class="divHTMLDB"></div>
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divCoordinatorTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divCoordinatorTableHTMLDB.id">
                                <input data-object-id="#divCoordinatorTableHTMLDB.id" class="" id="bSelectObjectGhost#divCoordinatorTableHTMLDB.id" name="bSelectObjectGhost#divCoordinatorTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divCoordinatorTableHTMLDB.id</td>
                        
<td>#divCoordinatorTableHTMLDB.column0</td>
<td>#divCoordinatorTableHTMLDB.column1</td>
<td>#divCoordinatorTableHTMLDB.column2</td>
<td>#divCoordinatorTableHTMLDB.column3</td>
<td>#divCoordinatorTableHTMLDB.column4</td>
<td>#divCoordinatorTableHTMLDB.column5</td>
                        <td>
                            <button data-object-id="#divCoordinatorTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divCoordinatorTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divCoordinatorTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divCoordinatorTableHTMLDB.id">
                                <input data-object-id="#divCoordinatorTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divCoordinatorTableHTMLDB.id" name="bSelectObject#divCoordinatorTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divCoordinatorTableHTMLDB.column5</td>
        ...
        <script src="assets/js/coordinatorclass.js"></script>
    </body>
</html>