<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="auditstepclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Audit'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Category'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Index'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Satisfied'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Yes'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('No'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
                        <th></th>
                    </tr>
                </thead>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('AuditStep'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('No'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('AuditStep'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
                        ...
                        <form id="formObject" name="formObject" method="post" class="form-horizontal">
                            ...
                            <div class="row"> 
								...
								<div class="col l12 m12 s12 " id="divaudit_id">
									<label for="audit_id"><?php echo __('Audit'); ?>  </label>
									<select class="selectClassSelection" id="audit_id" style="width: 100%" name="audit_id" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
								<div class="col l12 m12 s12 " id="divaudit_step_category_id">
									<label for="audit_step_category_id"><?php echo __('Category'); ?>  </label>
									<select class="selectClassSelection" id="audit_step_category_id" style="width: 100%" name="audit_step_category_id" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
								<div class="col l12 m12 s12 " id="divaudit_step_type_id">
									<label for="audit_step_type_id"><?php echo __('Type'); ?>  </label>
									<select class="selectClassSelection" id="audit_step_type_id" style="width: 100%" name="audit_step_type_id" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
	<div class="col l12 m12 s12 " id="divindex">
	                                    <label for="index"><?php echo __('Index'); ?> </label>
	                                    <div class="input-field">
		                                    <input id="index" name="index" type="text" class="blue-text text-darken-4" placeholder="" min="" max="" value="" >
	                                    </div>
                                    </div>
	<div class="col l12 m12 s12 " id="divstep_action">
	                                    <label for="step_action"><?php echo __('Step Action'); ?> </label>
	                                    <div class="input-field">
		                                    <textarea id="step_action" name="step_action" class="materialize-textarea blue-text text-darken-4" placeholder="" style="height:0px;overflow-y:hidden;" ></textarea>
	                                    </div>
                                    </div>
	<div class="col l12 m12 s12 " id="divyes">
                                    <p>
                                        <label class="checkbox2" for="yes">
                                        <input id="yes" name="yes" type="checkbox" value="1" >
                                        <span class="outer">
                                            <span class="inner"></span>
                                        </span><?php echo __('Yes'); ?> </label>
                                    </p>
                                </div>
	<div class="col l12 m12 s12 " id="divno">
                                    <p>
                                        <label class="checkbox2" for="no">
                                        <input id="no" name="no" type="checkbox" value="1" >
                                        <span class="outer">
                                            <span class="inner"></span>
                                        </span><?php echo __('No'); ?> </label>
                                    </p>
                                </div>
	<div class="col l12 m12 s12 " id="divaudit_note">
	                                    <label for="audit_note"><?php echo __('Audit Note'); ?> </label>
	                                    <div class="input-field">
		                                    <textarea id="audit_note" name="audit_note" class="materialize-textarea blue-text text-darken-4" placeholder="" style="height:0px;overflow-y:hidden;" ></textarea>
	                                    </div>
                                    </div>
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('AuditStep object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
    ...
    <div id="divBrowseMediaDialog" class="divDialogContent" data-target-file-list="" data-media-type="">
        ...
        <div class="divHiddenElements">
            <div id="divAuditStepHTMLDB" class="divHTMLDB"></div>
            <div id="divAuditStepTableHTMLDB" class="divHTMLDB"></div>
            <div id="divaudit_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divaudit_step_category_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divaudit_step_type_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divAuditStepTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divAuditStepTableHTMLDB.id">
                                <input data-object-id="#divAuditStepTableHTMLDB.id" class="" id="bSelectObjectGhost#divAuditStepTableHTMLDB.id" name="bSelectObjectGhost#divAuditStepTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divAuditStepTableHTMLDB.id</td>
                        
<td>#divAuditStepTableHTMLDB.column0</td>
<td>#divAuditStepTableHTMLDB.column1</td>
<td>#divAuditStepTableHTMLDB.column2</td>
<td>#divAuditStepTableHTMLDB.column3</td>
<td>#divAuditStepTableHTMLDB.column4</td>
<td>#divAuditStepTableHTMLDB.column5</td>
<td>#divAuditStepTableHTMLDB.column6</td>
                        <td>
                            <button data-object-id="#divAuditStepTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divAuditStepTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divAuditStepTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divAuditStepTableHTMLDB.id">
                                <input data-object-id="#divAuditStepTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divAuditStepTableHTMLDB.id" name="bSelectObject#divAuditStepTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divAuditStepTableHTMLDB.column6</td>
        ...
        <script src="assets/js/auditstepclass.js"></script>
    </body>
</html>