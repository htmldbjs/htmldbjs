<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="crewmemberclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Crew'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Leader'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Firstname'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Lastname'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Email'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Phone'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
                        <th></th>
                    </tr>
                </thead>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('CrewMember'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Phone'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('CrewMember'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
	...
	<div class="col l12 m12 s12 " id="divenabled">
                                    <div class="switch">
                                        <label>
                                            <input id="enabled" name="enabled" type="checkbox" checked >
                                            <span class="lever"></span><?php echo __('Enabled'); ?>  
                                        </label>
                                    </div>
                                </div>
								<div class="col l12 m12 s12 " id="divcrew_id">
									<label for="crew_id"><?php echo __('Crew'); ?>  </label>
									<select class="selectClassSelection" id="crew_id" style="width: 100%" name="crew_id" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
	<div class="col l12 m12 s12 " id="divleader">
                                    <div class="switch">
                                        <label>
                                            <input id="leader" name="leader" type="checkbox" checked >
                                            <span class="lever"></span><?php echo __('Leader'); ?>  
                                        </label>
                                    </div>
                                </div>
	...
	<div class="col l12 m12 s12 " id="divemail">
                                    ...
                                    <div class="input-field">
                                        <input id="email" name="email" type="email" class="blue-text text-darken-4" placeholder="" value="" >
                                    </div>
                                </div>
	<div class="col l12 m12 s12 " id="divphone">
	                                    <label for="phone"><?php echo __('Phone'); ?> </label>
	                                    <div class="input-field">
		                                    <input id="phone" name="phone" type="tel" class="blue-text text-darken-4" placeholder="" value="" >
	                                    </div>
                                    </div>
	<div class="col l12 m12 s12 " id="divpassword">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('CrewMember object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
        ...
        <div class="divHiddenElements">
            <div id="divCrewMemberHTMLDB" class="divHTMLDB"></div>
            <div id="divCrewMemberTableHTMLDB" class="divHTMLDB"></div>
            <div id="divcrew_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divSessionHTMLDB" class="divHTMLDB"></div>
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divCrewMemberTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divCrewMemberTableHTMLDB.id">
                                <input data-object-id="#divCrewMemberTableHTMLDB.id" class="" id="bSelectObjectGhost#divCrewMemberTableHTMLDB.id" name="bSelectObjectGhost#divCrewMemberTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divCrewMemberTableHTMLDB.id</td>
                        
<td>#divCrewMemberTableHTMLDB.column0</td>
<td>#divCrewMemberTableHTMLDB.column1</td>
<td>#divCrewMemberTableHTMLDB.column2</td>
<td>#divCrewMemberTableHTMLDB.column3</td>
<td>#divCrewMemberTableHTMLDB.column4</td>
<td>#divCrewMemberTableHTMLDB.column5</td>
<td>#divCrewMemberTableHTMLDB.column6</td>
                        <td>
                            <button data-object-id="#divCrewMemberTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divCrewMemberTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divCrewMemberTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divCrewMemberTableHTMLDB.id">
                                <input data-object-id="#divCrewMemberTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divCrewMemberTableHTMLDB.id" name="bSelectObject#divCrewMemberTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divCrewMemberTableHTMLDB.column6</td>
        ...
        <script src="assets/js/crewmemberclass.js"></script>
    </body>
</html>