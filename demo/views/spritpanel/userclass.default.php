<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="userclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('User Type'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
...
<th><button type="button" class="buttonTableColumn"><?php echo __('E-mail'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('User'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('E-mail'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
	...
	<div class="col l12 m12 s12 " id="divuser_type">
                                    <label for="user_type"><?php echo __('User Type'); ?> </label>
                                    <select class="selectSelectizeStandard" id="user_type" style="width: 100%" name="user_type"  data-min-selection="2" data-max-selection="2">
                                    	<option value=""><?php echo __('Please Select'); ?></option>
                                    	<option value="1"><?php echo __('Admin'); ?></option>
<option value="2"><?php echo __('Consultant'); ?></option>
<option value="3"><?php echo __('Sponsor'); ?></option>
<option value="4"><?php echo __('Coordinator'); ?></option>
<option value="5"><?php echo __('Process Owner'); ?></option>
<option value="6"><?php echo __('Champion'); ?></option>
...
<option value="9"><?php echo __('Crew'); ?></option>
								...
								<div class="col l12 m12 s12 " id="divcompany">
									...
									<select class="selectClassSelection" id="company" style="width: 100%" name="company" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
	...
	<div class="col l12 m12 s12 " id="divpassword">
        ...
        <div class="divHiddenElements">
            ...
            <div id="divUserTableHTMLDB" class="divHTMLDB"></div>
            <div id="divcompanyPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divSessionHTMLDB" class="divHTMLDB"></div>
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divUserTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divUserTableHTMLDB.id">
                                <input data-object-id="#divUserTableHTMLDB.id" class="" id="bSelectObjectGhost#divUserTableHTMLDB.id" name="bSelectObjectGhost#divUserTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divUserTableHTMLDB.id</td>
                        
<td>#divUserTableHTMLDB.column0</td>
<td>#divUserTableHTMLDB.column1</td>
<td>#divUserTableHTMLDB.column2</td>
<td>#divUserTableHTMLDB.column3</td>
<td>#divUserTableHTMLDB.column4</td>
<td>#divUserTableHTMLDB.column5</td>
                        <td>
                            <button data-object-id="#divUserTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divUserTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divUserTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divUserTableHTMLDB.id">
                                <input data-object-id="#divUserTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divUserTableHTMLDB.id" name="bSelectObject#divUserTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divUserTableHTMLDB.column5</td>
        ...
        <script src="assets/js/userclass.js"></script>
    </body>
</html>