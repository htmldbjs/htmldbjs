<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="auditstepdirectoryclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('No'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('AuditStepDirectory'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('No'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('AuditStepDirectory'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('AuditStepDirectory object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
    ...
    <div id="divBrowseMediaDialog" class="divDialogContent" data-target-file-list="" data-media-type="">
        ...
        <div class="divHiddenElements">
            <div id="divAuditStepDirectoryHTMLDB" class="divHTMLDB"></div>
            <div id="divAuditStepDirectoryTableHTMLDB" class="divHTMLDB"></div>
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divAuditStepDirectoryTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divAuditStepDirectoryTableHTMLDB.id">
                                <input data-object-id="#divAuditStepDirectoryTableHTMLDB.id" class="" id="bSelectObjectGhost#divAuditStepDirectoryTableHTMLDB.id" name="bSelectObjectGhost#divAuditStepDirectoryTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divAuditStepDirectoryTableHTMLDB.id</td>
                        
<td>#divAuditStepDirectoryTableHTMLDB.column0</td>
<td>#divAuditStepDirectoryTableHTMLDB.column1</td>
<td>#divAuditStepDirectoryTableHTMLDB.column2</td>
<td>#divAuditStepDirectoryTableHTMLDB.column3</td>
<td>#divAuditStepDirectoryTableHTMLDB.column4</td>
<td>#divAuditStepDirectoryTableHTMLDB.column5</td>
                        <td>
                            <button data-object-id="#divAuditStepDirectoryTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divAuditStepDirectoryTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divAuditStepDirectoryTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divAuditStepDirectoryTableHTMLDB.id">
                                <input data-object-id="#divAuditStepDirectoryTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divAuditStepDirectoryTableHTMLDB.id" name="bSelectObject#divAuditStepDirectoryTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divAuditStepDirectoryTableHTMLDB.column5</td>
        ...
        <script src="assets/js/auditstepdirectoryclass.js"></script>
    </body>
</html>