<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="applicationsubtaskclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Application Task'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Sub Task Code'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Title'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('ApplicationSubTask'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('ApplicationSubTask'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
                        ...
                        <form id="formObject" name="formObject" method="post" class="form-horizontal">
                            ...
                            <div class="row"> 
								...
								<div class="col l12 m12 s12 " id="divapplication_task_id">
									<label for="application_task_id"><?php echo __('Application Task'); ?>  </label>
									<select class="selectClassSelection" id="application_task_id" style="width: 100%" name="application_task_id" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
	<div class="col l12 m12 s12 " id="divapplication_sub_task_code">
                                    <label for="application_sub_task_code"><?php echo __('Sub Task Code'); ?> </label>
                                    <div class="input-field">
                                        <input id="application_sub_task_code" name="application_sub_task_code" type="text" class="blue-text text-darken-4" placeholder="" value=""  >
                                    </div>
                                </div>
	<div class="col l12 m12 s12 " id="divtitle">
                                    <label for="title"><?php echo __('Title'); ?> </label>
                                    <div class="input-field">
                                        <input id="title" name="title" type="text" class="blue-text text-darken-4" placeholder="" value=""  >
                                    </div>
                                </div>
	...
	<div class="col l12 m12 s12 " id="divsub_task_action">
	                                    <label for="sub_task_action"><?php echo __('Sub Task Action'); ?> </label>
	                                    <div class="input-field">
		                                    <textarea id="sub_task_action" name="sub_task_action" class="materialize-textarea blue-text text-darken-4" placeholder="" style="height:0px;overflow-y:hidden;" ></textarea>
	                                    </div>
                                    </div>
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('ApplicationSubTask object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
    ...
    <div id="divBrowseMediaDialog" class="divDialogContent" data-target-file-list="" data-media-type="">
        ...
        <div class="divHiddenElements">
            <div id="divApplicationSubTaskHTMLDB" class="divHTMLDB"></div>
            <div id="divApplicationSubTaskTableHTMLDB" class="divHTMLDB"></div>
            <div id="divapplication_task_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divApplicationSubTaskTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divApplicationSubTaskTableHTMLDB.id">
                                <input data-object-id="#divApplicationSubTaskTableHTMLDB.id" class="" id="bSelectObjectGhost#divApplicationSubTaskTableHTMLDB.id" name="bSelectObjectGhost#divApplicationSubTaskTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divApplicationSubTaskTableHTMLDB.id</td>
                        
<td>#divApplicationSubTaskTableHTMLDB.column0</td>
<td>#divApplicationSubTaskTableHTMLDB.column1</td>
<td>#divApplicationSubTaskTableHTMLDB.column2</td>
<td>#divApplicationSubTaskTableHTMLDB.column3</td>
                        <td>
                            <button data-object-id="#divApplicationSubTaskTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divApplicationSubTaskTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divApplicationSubTaskTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divApplicationSubTaskTableHTMLDB.id">
                                <input data-object-id="#divApplicationSubTaskTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divApplicationSubTaskTableHTMLDB.id" name="bSelectObject#divApplicationSubTaskTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divApplicationSubTaskTableHTMLDB.column3</td>
        ...
        <script src="assets/js/applicationsubtaskclass.js"></script>
    </body>
</html>