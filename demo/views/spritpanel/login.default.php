			...
			<div class="divDialogContentContainer">
				<header class="headerHero z-depth-1 blue darken-4">
					<div class="divHeaderInfo">
						<h3 class="blue-text text-darken-4"><?php echo __('Log in'); ?></h3>
					</div>
				</header>
					...
					<form id="formLogin" name="formLogin" method="post" action="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>login/formlogin" class="form-horizontal" target="iframeFormLogin">
						...
						<div class="row">
							<div class="input-field">
								<div class="col s12">
									<input id="strLoginEmail" name="strLoginEmail" type="text" class="blue-text text-darken-4" value="" placeholder="<?php echo __('Email Address'); ?>" style="font-size: 1.25rem">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="input-field">
								<div class="col s12">
									<input id="strLoginPassword" name="strLoginPassword" type="password" class="blue-text text-darken-4" value="" placeholder="<?php echo __('Password'); ?>" style="font-size: 1.25rem">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col s12 right-align">
								<a id="aForgotPasswordLink" class="blue-text text-darken-4" href="JavaScript:void(0);"><?php echo __('Forgot Password?'); ?></a>
							</div>
						</div>
						<div class="row">
							<div class="input-field">
								<div class="col s12">
									<button id="buttonSubmitLoginForm" name="buttonSubmitLoginForm" data-default-text="<?php echo __('Login'); ?>" data-loading-text="<?php echo __('Logging in...'); ?>" type="submit" class="waves-effect waves-light btn-large blue darken-4 col s12"><?php echo __('Login'); ?></button>
								</div>
							</div>
						</div>
					</form>
