<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="auditsteptypeclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Name'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('AuditStepType'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Name'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('AuditStepType'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
	...
	<div class="col l12 m12 s12 " id="divname">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('AuditStepType object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
        ...
        <div class="divHiddenElements">
            <div id="divAuditStepTypeHTMLDB" class="divHTMLDB"></div>
            <div id="divAuditStepTypeTableHTMLDB" class="divHTMLDB"></div>
            <div id="divSessionHTMLDB" class="divHTMLDB"></div>
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divAuditStepTypeTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divAuditStepTypeTableHTMLDB.id">
                                <input data-object-id="#divAuditStepTypeTableHTMLDB.id" class="" id="bSelectObjectGhost#divAuditStepTypeTableHTMLDB.id" name="bSelectObjectGhost#divAuditStepTypeTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divAuditStepTypeTableHTMLDB.id</td>
                        
<td>#divAuditStepTypeTableHTMLDB.column0</td>
<td>#divAuditStepTypeTableHTMLDB.column1</td>
<td>#divAuditStepTypeTableHTMLDB.column2</td>
                        <td>
                            <button data-object-id="#divAuditStepTypeTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divAuditStepTypeTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divAuditStepTypeTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divAuditStepTypeTableHTMLDB.id">
                                <input data-object-id="#divAuditStepTypeTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divAuditStepTypeTableHTMLDB.id" name="bSelectObject#divAuditStepTypeTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divAuditStepTypeTableHTMLDB.column2</td>
        ...
        <script src="assets/js/auditsteptypeclass.js"></script>
    </body>
</html>