<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="applicationclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Application Date'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Application Code'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
<th><button type="button" class="buttonTableColumn"><?php echo __('Unit'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Application'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Unit'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Application'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
	...
	<div class="col l12 m12 s12 " id="divapplication_date">
		<label for="application_date"><?php echo __('Application Date'); ?>  </label>
		<div class="input-field">
			<input id="application_date" name="application_date" type="date" class="datepickerDate blue-text text-darken-4" placeholder="" value=""  >
		</div>
	</div>
	<div class="col l12 m12 s12 " id="divapplication_code">
                                    <label for="application_code"><?php echo __('Application Code'); ?> </label>
                                    <div class="input-field">
                                        <input id="application_code" name="application_code" type="text" class="blue-text text-darken-4" placeholder="" value=""  >
                                    </div>
                                </div>
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('Application object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
        ...
        <div class="divHiddenElements">
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divApplicationTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divApplicationTableHTMLDB.id">
                                <input data-object-id="#divApplicationTableHTMLDB.id" class="" id="bSelectObjectGhost#divApplicationTableHTMLDB.id" name="bSelectObjectGhost#divApplicationTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divApplicationTableHTMLDB.id</td>
                        
<td>#divApplicationTableHTMLDB.column0</td>
<td>#divApplicationTableHTMLDB.column1</td>
<td>#divApplicationTableHTMLDB.column2</td>
                        <td>
                            <button data-object-id="#divApplicationTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divApplicationTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divApplicationTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divApplicationTableHTMLDB.id">
                                <input data-object-id="#divApplicationTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divApplicationTableHTMLDB.id" name="bSelectObject#divApplicationTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divApplicationTableHTMLDB.column2</td>
        ...
        <script src="assets/js/applicationclass.js"></script>
    </body>
</html>