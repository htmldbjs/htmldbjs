<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="applicationtaskcategoryclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Name'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('ApplicationTaskCategory'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Name'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('ApplicationTaskCategory'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
	...
	<div class="col l12 m12 s12 " id="divname">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('ApplicationTaskCategory object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
        ...
        <div class="divHiddenElements">
            <div id="divApplicationTaskCategoryHTMLDB" class="divHTMLDB"></div>
            <div id="divApplicationTaskCategoryTableHTMLDB" class="divHTMLDB"></div>
            <div id="divSessionHTMLDB" class="divHTMLDB"></div>
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divApplicationTaskCategoryTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divApplicationTaskCategoryTableHTMLDB.id">
                                <input data-object-id="#divApplicationTaskCategoryTableHTMLDB.id" class="" id="bSelectObjectGhost#divApplicationTaskCategoryTableHTMLDB.id" name="bSelectObjectGhost#divApplicationTaskCategoryTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divApplicationTaskCategoryTableHTMLDB.id</td>
                        
<td>#divApplicationTaskCategoryTableHTMLDB.column0</td>
<td>#divApplicationTaskCategoryTableHTMLDB.column1</td>
<td>#divApplicationTaskCategoryTableHTMLDB.column2</td>
                        <td>
                            <button data-object-id="#divApplicationTaskCategoryTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divApplicationTaskCategoryTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divApplicationTaskCategoryTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divApplicationTaskCategoryTableHTMLDB.id">
                                <input data-object-id="#divApplicationTaskCategoryTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divApplicationTaskCategoryTableHTMLDB.id" name="bSelectObject#divApplicationTaskCategoryTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divApplicationTaskCategoryTableHTMLDB.column2</td>
        ...
        <script src="assets/js/applicationtaskcategoryclass.js"></script>
    </body>
</html>