<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="actionclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('Step'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Action'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Action'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
                        ...
                        <form id="formObject" name="formObject" method="post" class="form-horizontal">
                            ...
                            <div class="row"> 
								...
								<div class="col l12 m12 s12 " id="divstep_id">
									<label for="step_id"><?php echo __('Step'); ?>  </label>
									<select class="selectClassSelection" id="step_id" style="width: 100%" name="step_id" data-min-selection="2" data-max-selection="2">
	...
	<div class="col l12 m12 s12 " id="divcompletion_date">
		...
		<div class="input-field">
			<input id="completion_date" name="completion_date" type="date" class="datepickerDate blue-text text-darken-4" placeholder="" value=""  >
								...
								<div class="col l12 m12 s12 " id="divactionstate_id">
									<label for="actionstate_id"><?php echo __('State'); ?>  </label>
									<select class="selectClassSelection" id="actionstate_id" style="width: 100%" name="actionstate_id" data-min-selection="2" data-max-selection="2">
										<option value=""><?php echo __('Please Select'); ?></option>
									</select>
								</div>
                            </div>
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('Action object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
    ...
    <div id="divBrowseMediaDialog" class="divDialogContent" data-target-file-list="" data-media-type="">
        ...
        <div class="divHiddenElements">
            <div id="divActionHTMLDB" class="divHTMLDB"></div>
            <div id="divActionTableHTMLDB" class="divHTMLDB"></div>
            <div id="divstep_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divactionstate_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divActionTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divActionTableHTMLDB.id">
                                <input data-object-id="#divActionTableHTMLDB.id" class="" id="bSelectObjectGhost#divActionTableHTMLDB.id" name="bSelectObjectGhost#divActionTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divActionTableHTMLDB.id</td>
                        
<td>#divActionTableHTMLDB.column0</td>
<td>#divActionTableHTMLDB.column1</td>
<td>#divActionTableHTMLDB.column2</td>
                        <td>
                            <button data-object-id="#divActionTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divActionTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divActionTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divActionTableHTMLDB.id">
                                <input data-object-id="#divActionTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divActionTableHTMLDB.id" name="bSelectObject#divActionTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divActionTableHTMLDB.column2</td>
        ...
        <script src="assets/js/actionclass.js"></script>
    </body>
</html>