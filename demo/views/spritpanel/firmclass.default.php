<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="firmclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Firm'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('Firm'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
	...
	<div class="col l12 m12 s12 " id="divname">
								...
								<div class="col l12 m12 s12 " id="divfirmstate_id">
									<label for="firmstate_id"><?php echo __('State'); ?>  </label>
									<select class="selectClassSelection" id="firmstate_id" style="width: 100%" name="firmstate_id" data-min-selection="2" data-max-selection="2">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('Firm object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
        ...
        <div class="divHiddenElements">
            <div id="divFirmHTMLDB" class="divHTMLDB"></div>
            <div id="divFirmTableHTMLDB" class="divHTMLDB"></div>
            <div id="divfirmstate_idPropertyOptionsHTMLDB" class="divHTMLDB"></div>
            <div id="divSessionHTMLDB" class="divHTMLDB"></div>
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divFirmTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divFirmTableHTMLDB.id">
                                <input data-object-id="#divFirmTableHTMLDB.id" class="" id="bSelectObjectGhost#divFirmTableHTMLDB.id" name="bSelectObjectGhost#divFirmTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divFirmTableHTMLDB.id</td>
                        
<td>#divFirmTableHTMLDB.column0</td>
<td>#divFirmTableHTMLDB.column1</td>
                        <td>
                            <button data-object-id="#divFirmTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divFirmTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divFirmTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divFirmTableHTMLDB.id">
                                <input data-object-id="#divFirmTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divFirmTableHTMLDB.id" name="bSelectObject#divFirmTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divFirmTableHTMLDB.column1</td>
        ...
        <script src="assets/js/firmclass.js"></script>
    </body>
</html>