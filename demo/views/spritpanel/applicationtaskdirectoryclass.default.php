<?php includeView($controller, 'spritpanel/head'); ?>
    <body data-active-page-csv="" data-active-dialog="" data-url-prefix="<?php echo $_SPRIT['SPRITPANEL_URL_PREFIX']; ?>" data-page-url="applicationtaskdirectoryclass">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectsContent" class="divPageContent divFullPage" data-page-header="<?php echo __('ApplicationTaskDirectory'); ?>">
...
<th><button type="button" class="buttonTableColumn"><?php echo __('State'); ?>&nbsp;<span class="sorting sorting-desc blue-text text-darken-4"><i class="ion-arrow-down-b"></i></span><span class="sorting sorting-asc blue-text text-darken-4"><i class="ion-arrow-up-b"></i></span></button></th>
        ...
        <div id="divObjectContent" class="divPageContent divFullPage" data-page-header="<?php echo __('ApplicationTaskDirectory'); ?>">
            <div class="divContentWrapper ">
                <div class="divDialogContentContainer col s12">
                    <div class="divContentPanel z-depth-1">
                        ...
                        <form id="formConfirmDelete" name="formConfirmDelete" method="post" class="form-horizontal">
                            <div class="row" style="margin-bottom: 40px;">
                                <div class="col s12 red-text text-darken-4">
                                    <?php echo __('Selected'); ?> <span id="spanDeleteSelection"></span> <?php echo __('ApplicationTaskDirectory object'); ?><span id="spanPluralSuffix"><?php echo __('s'); ?></span> <?php echo __('will be deleted.'); ?> <?php echo __('Do you confirm?'); ?>
                                </div>
                            </div>
                            <div class="row">
                                <div class="input-field">
    ...
    <div id="divBrowseMediaDialog" class="divDialogContent" data-target-file-list="" data-media-type="">
        ...
        <div class="divHiddenElements">
            <div id="divApplicationTaskDirectoryHTMLDB" class="divHTMLDB"></div>
            <div id="divApplicationTaskDirectoryTableHTMLDB" class="divHTMLDB"></div>
            ...
            <table>
                <tbody id="tbodyGhostObjectListTemplate">
                    <tr class="tr#divApplicationTaskDirectoryTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObjectGhost#divApplicationTaskDirectoryTableHTMLDB.id">
                                <input data-object-id="#divApplicationTaskDirectoryTableHTMLDB.id" class="" id="bSelectObjectGhost#divApplicationTaskDirectoryTableHTMLDB.id" name="bSelectObjectGhost#divApplicationTaskDirectoryTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
                        </td>
                        <td>#divApplicationTaskDirectoryTableHTMLDB.id</td>
                        
<td>#divApplicationTaskDirectoryTableHTMLDB.column0</td>
<td>#divApplicationTaskDirectoryTableHTMLDB.column1</td>
<td>#divApplicationTaskDirectoryTableHTMLDB.column2</td>
<td>#divApplicationTaskDirectoryTableHTMLDB.column3</td>
<td>#divApplicationTaskDirectoryTableHTMLDB.column4</td>
                        <td>
                            <button data-object-id="#divApplicationTaskDirectoryTableHTMLDB.id" class="buttonTableListAction buttonDeleteObject right" type="button">
                                <i class="ion-android-delete"></i>
                            </button>
                            <button data-object-id="#divApplicationTaskDirectoryTableHTMLDB.id" class="buttonTableListAction buttonEditObject right" type="button">
            ...
            <table>
                <tbody id="tbodyObjectListTemplate">
                    <tr class="tr#divApplicationTaskDirectoryTableHTMLDB.id">
                        <td class="center">
                            <label class="checkbox2 left-align" for="bSelectObject#divApplicationTaskDirectoryTableHTMLDB.id">
                                <input data-object-id="#divApplicationTaskDirectoryTableHTMLDB.id" class="bSelectObject" id="bSelectObject#divApplicationTaskDirectoryTableHTMLDB.id" name="bSelectObject#divApplicationTaskDirectoryTableHTMLDB.id" value="1" type="checkbox">
                                <span class="outer">
                                    <span class="inner"></span>
                                </span>
                            </label>
...
<td>#divApplicationTaskDirectoryTableHTMLDB.column4</td>
        ...
        <script src="assets/js/applicationtaskdirectoryclass.js"></script>
    </body>
</html>