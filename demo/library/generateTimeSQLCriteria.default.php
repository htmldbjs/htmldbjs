<?php
/**
 * generateTimeSQLCriteria - generates time property sql criteria
 *
...
function generateTimeSQLCriteria($property, $filters, $connection, $criteriaSQL) {
    ...
    if (isset($filters[$property . 'InValues'])) {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $criteriaSQL .= '\''
                    . date('H:i:s', intval($filters[$property . 'InValues'][$i]))
                    . '\'';
        } // for ($i = 0; $i < $count; $i++) {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            $criteriaSQL .= '\''
                    . date('H:i:s', intval($filters[$property . 'NotInValues'][$i]))
                    . '\'';
        } // for ($i = 0; $i < $count; $i++) {
        ...
        if (isset($filters[$property . 'MinExclusive'])) {
            ...
            $criteriaSQL .= '(`' . $tableField . '` > \''
                    . date('H:i:s', $filters[$property . 'MinExclusive'])
                    . '\')';
            ...
            $criteriaSQL .= '(`' . $tableField . '` >= \''
                    . date('H:i:s', $filters[$property . 'MinInclusive'])
                    . '\')';
        ...
        if (isset($filters[$property . 'MaxExclusive'])) {
            ...
            $criteriaSQL .= '(`' . $tableField . '` < \''
                            . date('H:i:s', $filters[$property . 'MaxExclusive'])
                            . '\')';
            ...
            $criteriaSQL .= '(`' . $tableField . '` <= \''
                            . date('H:i:s', $filters[$property . 'MaxInclusive'])
                            . '\')';
