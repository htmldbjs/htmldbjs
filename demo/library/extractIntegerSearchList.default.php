<?php
/**
 * extractIntegerSearchList - extract IDs from cached search
 * file based on integer value array.
 *
 * @param strClassName [String][in]: Class Name
 * @param strClassPropertyName [String][in]: Class Property Name to be extracted
 * @param arrlValues [long Array][in]: Integer values to be extracted 
 *
...
function extractIntegerSearchList($strClassName,
    ...
    $arrlValues = array_flip($arrlValues);
