...
| ---- | ---- |
| [`htmldb-button-add`](docs/elements/htmldb-button-add.md) | An action button is used for adding a new record to the specified table. When `htmldb-button-add` button is clicked related forms are reset. |
| [`htmldb-button-edit`](docs/elements/htmldb-button-edit.md) | An action button is used for editing a specific record. When `htmldb-button-edit` button is clicked `htmldb-table` element's active id is set to the specified record. Additionally, all related form fields are populated with the values of the record. |
| [`htmldb-button-refresh`](docs/elements/htmldb-button-refresh.md) | An action button is used for refreshing all `htmldb-table` elements. |
...
| [`htmldb-input-save`](docs/elements/htmldb-input-save.md) | A standalone input that automatically update the specific `htmldb-table` record. |
| [`htmldb-message`](docs/elements/htmldb-message.md) | A container element for the messages. |
| [`htmldb-pagination`](docs/elements/htmldb-pagination.md) | A container element for easily navigating among the pages of `htmldb-table` element. |
| [`htmldb-section`](docs/elements/htmldb-section.md) | A container for the elements, that automatically rendered by the related `htmldb-table`. |
| [`htmldb-select`](docs/elements/htmldb-select.md) | A select element that automatically populated with the related `htmldb-table`. |
| [`htmldb-table`](docs/elements/htmldb-table.md) | Data source element that retrieves and stores data from the server. Also, it validates and posts data to the server. |
| [`htmldb-table-validation`](docs/elements/htmldb-table-validation.md) | A container element for conditions validated locally before writing a record to `htmldb-table` element. |
| [`htmldb-template`](docs/elements/htmldb-template.md) | A container element for the templates, that are automatically rendered by related `htmldb-table`. |
| [`htmldb-toggle`](docs/elements/htmldb-toggle.md) | A special container for the form fields that automatically displayed or hided for a certain condition. |
